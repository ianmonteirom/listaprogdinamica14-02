...
def cria_naipe(naipe):
    cartas = []
    cartas_letras = ['J', 'Q', 'K']
    cartas.append('A'+f'{naipe}')

    for i in range(2, 11):
        cartas.append(str(i)+f'{naipe}')

    for j in range(len(cartas_letras)):
        cartas.append(cartas_letras[j]+f'{naipe}')
...
def cria_baralho():
    ...
    naipe_ouros = cria_naipe('o')
    naipe_copas = cria_naipe('c')
    naipe_espadas = cria_naipe('e')
    naipe_paus = cria_naipe('p')

    baralho=[naipe_ouros, naipe_copas, naipe_espadas, naipe_paus]
